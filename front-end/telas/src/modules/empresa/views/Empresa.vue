      ...
      <v-container>
            ...
            >
              <template v-slot:activator="{ on, attrs }">
                <v-text-field
                  ...
                  persistent-hint
                  v-bind="attrs"
                  @blur="dataAdmissao1 = parseDate(dataAdmissaoFormatada1)"
                  v-on="on"
                  outlined
                  disabled
                ></v-text-field>
        ...
        <v-card>
          <v-tabs v-model="tab" background-color="primary" dark>
            ...
            <v-tab key="Produtos e Coberturas"> Produtos e Coberturas </v-tab>
          </v-tabs>
              ...
              <v-card>
                  ...
                  <v-row>
                    ...
                    <v-col cols="12" sm="2">
                      ...
                      >
                        <template v-slot:activator="{ on, attrs }">
                          <v-text-field
                            v-model="dataAdmissaoFormatada2"
                            label="Data Admissão"
                            persistent-hint
                            v-bind="attrs"
                            @blur="
                              dataAdmissao2 = parseDate(dataAdmissaoFormatada2)
                            "
                            v-on="on"
                            outlined
                            hide-details="auto"
                ...
                <v-card-actions>
                  <v-row class="mt-2 ml-2 pb-2">
                    <v-btn color="primary" large>Salvar</v-btn>
                  </v-row>
                </v-card-actions>
              </v-card>
            </v-tab-item>
                  ...
                  <v-row class="mt-2">
                    ...
                    <v-col cols="12" sm="2">
                      ...
                      >
                        <template v-slot:activator="{ on, attrs }">
                          <v-text-field
                            v-model="dataVigenciaInicioFormatada"
                        ...
                        <v-date-picker
                          ...
                          no-title
                          @input="dataVigenciaInicioMenu = false"
                        ></v-date-picker>
                      </v-menu>
                    </v-col>
                    <v-col cols="12" sm="2">
                      ...
                      >
                        <template v-slot:activator="{ on, attrs }">
                          <v-text-field
                            v-model="dataVigenciaFimFormatada"
                        ...
                        <v-date-picker
                          ...
                          no-title
                          @input="dataVigenciaFimMenu = false"
                        ></v-date-picker>
                      </v-menu>
                    </v-col>
                  </v-row>
                  ...
                  <v-row class="mt-2">
                    ...
                    <v-col cols="12" sm="2">
                      <v-menu
                        ...
                        v-model="dataVigenciaInicioCoberturaMenu"
                        :close-on-content-click="false"
                        transition="scale-transition"
                        offset-y
                        max-width="290px"
                      ...
                      >
                        <template v-slot:activator="{ on, attrs }">
                          <v-text-field
                            v-model="dataVigenciaInicioCoberturaFormatada"
                            label="Início de Vigência"
                            persistent-hint
                            v-bind="attrs"
                            @blur="
                        ...
                        <v-date-picker
                          v-model="dataVigenciaInicioCobertura"
                          no-title
                          @input="dataVigenciaInicioCoberturaMenu = false"
                        ></v-date-picker>
                      </v-menu>
                    </v-col>
                    <v-col cols="12" sm="2">
                      <v-menu
                        ...
                        v-model="dataVigenciaFimCoberturaMenu"
                        :close-on-content-click="false"
                        transition="scale-transition"
                        offset-y
                        max-width="290px"
                      ...
                      >
                        <template v-slot:activator="{ on, attrs }">
                          <v-text-field
                            v-model="dataVigenciaFimCoberturaFormatada"
                            label="Fim de Vigência"
                            persistent-hint
                            v-bind="attrs"
                            @blur="
                        ...
                        <v-date-picker
                          v-model="dataVigenciaFimCobertura"
                          no-title
                          @input="dataVigenciaFimCoberturaMenu = false"
                        ></v-date-picker>
                      </v-menu>
                    </v-col>
                    <v-col cols="12" sm="2">
...
export default {
  ...
  watch: {
    ...
    dataVigenciaFim() {
      this.dataVigenciaFimFormatada = this.formatDate(this.dataVigenciaFim);
    },
    dataVigenciaInicioCobertura() {
    ...
    dataVigenciaFimCobertura() {
      this.dataVigenciaFimCoberturaFormatada = this.formatDate(this.dataVigenciaFimCobertura);
    },
  },
